...
function Experience() {
  ...
  return (
    <motion.div
      ...
      className="relative mx-10 flex h-screen max-w-full flex-col items-center justify-evenly space-y-6 text-left"
    >
      <h1 className="mt-16 text-center text-2xl tracking-[20px] text-gray-500 md:mb-4">
        Experience
      </h1>
